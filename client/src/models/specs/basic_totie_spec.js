...
var basicTotie = new BasicTotie(basicPlaceResult.name, basicPlaceResult.geometry.location.lat, basicPlaceResult.geometry.location.lng, basicPlaceResult.placeId, basicPlaceResult.rating, basicPlaceResult.types);

var basicTotieTwo = new BasicTotie(basicPlaceResult.name, basicPlaceResult.geometry.location.lat, basicPlaceResult.geometry.location.lng, basicPlaceResult.placeId, basicPlaceResult.rating, basicPlaceResultTwo.types);
